    ...
    <section class="text-gray-600 body-font">
      <div class="container px-0 py-12 mx-auto">
        <div class="flex flex-col text-center w-full mb-4">
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">過去予想結果</h1>
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Specify the conditions and check the profits from using Izanami in the past.</p>
        </div>
          <section class="text-gray-600 body-font">
            ...
            <div class="text-center mb-5">
              <button class=" inline-block text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" v-on:click="checkResult">結果確認</button>
            </div>
          </section>
          <section class="text-gray-600 body-font">
            <div class="container px-5 py-5 mx-auto">
              ...
              <div class="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
                <div class="p-2 sm:w-1/2 w-full">
                  <div class="bg-gray-100 rounded flex p-4 h-full items-center">
                    ...
                    <span class="title-font font-medium text-black lg:w-2/5">回収率</span>
                    <span class="title-font font-medium text-black lg:w-3/5 text-right">
                       <span id="recoveryRate" class="title-font font-medium text-black"></span>
                       <span class="title-font font-medium text-black">%</span>
                    </span>
                  </div>
                </div>
                <div class="p-2 sm:w-1/2 w-full">
                  <div class="bg-gray-100 rounded flex p-4 h-full items-center">
                    ...
                    <span class="title-font font-medium text-black lg:w-2/5">的中率</span>
                    <span class="title-font font-medium text-black lg:w-3/5 text-right">
                       <span id="hitRate" class="title-font font-medium text-black"></span>
                       <span class="title-font font-medium text-black">%</span>
                    </span>
                  </div>
                </div>
                <div class="p-2 sm:w-1/2 w-full">
                  <div class="bg-gray-100 rounded flex p-4 h-full items-center">
                    ...
                    <span class="title-font font-medium text-black lg:w-2/5">購入金額</span>
                    <span class="title-font font-medium text-black lg:w-3/5 text-right">
                       <span id="purchaseAmount" class="title-font font-medium text-black"></span>
                       <span class="title-font font-medium text-black">円</span>
                    </span>
                  </div>
                </div>
                <div class="p-2 sm:w-1/2 w-full">
                  <div class="bg-gray-100 rounded flex p-4 h-full items-center">
                    ...
                    <span class="title-font font-medium text-black lg:w-2/5">購入回数</span>
                    <span class="title-font font-medium text-black lg:w-3/5 text-right">
                       <span id="purchaseCount" class="title-font font-medium text-black"></span>
                       <span class="title-font font-medium text-black">回</span>
                    </span>
                  </div>
                </div>
                <div class="p-2 sm:w-1/1 w-full">
                  <div class="bg-gray-100 rounded flex p-4 h-full items-center">
                    ...
                    <span class="title-font font-medium text-black lg:w-2/5">収支</span>
                    <span class="title-font font-medium text-black lg:w-3/5 text-right">
                       <span id="balance" class="title-font font-medium text-black"></span>
                       <span class="title-font font-medium text-black">円</span>
                    </span>
                  </div>
                </div>
    ...
    checkResult: function (event) {
      ...
      axios.get('api/statistics', {
        ...
        if (response.data.result === 'success') {
          ...
          document.getElementById('purchaseAmount').innerHTML = response.data.purchaseAmount
          ...
          document.getElementById('NGMessage').innerHTML = '結果が取得できませんでした'
        }
      })
    }
  }
