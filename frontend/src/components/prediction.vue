          ...
          <table class="table-auto w-full text-left whitespace-no-wrap">
            <tbody>
              <tr v-if="data.exacta">
                ...
                <td class="px-4 py-3">{{data.exacta[0][0]}}</td>
                <td class="px-4 py-3">{{data.exacta[0][1]}}</td>
                <td></td>
              </tr>
              <tr v-if="data.exacta">
                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">二連単</th>
                <td class="border-t-2 border-gray-200 px-4 py-3">{{data.exacta[0][0]}} - {{data.exacta[0][1]}}</td>
                <td class="border-t-2 border-gray-200 px-4 py-3">{{data.exacta[1][0]}} - {{data.exacta[1][1]}}</td>
                <td class="border-t-2 border-gray-200 px-4 py-3">{{data.exacta[2][0]}} - {{data.exacta[2][1]}}</td>
              </tr>
              <tr v-if="data.trifecta">
                ...
                <td class="border-t-2 border-gray-200 px-4 py-3">{{data.trifecta[0][0]}} - {{data.trifecta[0][1]}} - {{data.trifecta[0][2]}}</td>
              ...
              <tr v-if="data.quinella">
                ...
                <td class="border-t-2 border-gray-200 px-4 py-3">{{data.quinella[0][0]}} - {{data.quinella[0][1]}}</td>
                <td class="border-t-2 border-gray-200 px-4 py-3">{{data.quinella[1][0]}} - {{data.quinella[1][1]}}</td>
                <td class="border-t-2 border-gray-200 px-4 py-3">{{data.quinella[2][0]}} - {{data.quinella[2][1]}}</td>
              </tr>
              <tr v-if="data.trio">
                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">三連複</th>
                <td class="border-t-2 border-gray-200 px-4 py-3">{{data.trio[0][0]}} - {{data.trio[0][1]}} - {{data.trio[0][2]}}</td>
                <td class="border-t-2 border-gray-200 px-4 py-3">{{data.trio[1][0]}} - {{data.trio[1][1]}} - {{data.trio[1][2]}}</td>
                <td class="border-t-2 border-gray-200 px-4 py-3"></td>
              </tr>
            </tbody>
        </table>
