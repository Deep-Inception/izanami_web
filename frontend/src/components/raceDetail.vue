<template>
    <div>
      ...
      <div class="top-wrapper">
        ...
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">レース情報</h1>
        <div class="lg:w-3/4 w-full mx-auto overflow-auto">
          <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
              ...
              <th class="w-10 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tr rounded-br">チルト</th>
            </thead>
